  ...
  if (!session) {
    return (
      <div className="flex h-screen flex-col items-center justify-center gap-4">
        <h1 className="text-3xl font-bold">Multi-Agent Task Hub</h1>
        <p className="text-gray-600">Please sign in with GitHub to manage tasks</p>
        <button
    ...
    <main className="container mx-auto max-w-4xl p-6">
      <header className="mb-8 flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500">Connected to {process.env.NEXT_PUBLIC_REPO_OWNER}/{process.env.NEXT_PUBLIC_REPO_NAME}</p>
        </div>
        ...
        <section className="mb-8 rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700">Assigned Skill</label>
                <select
                  className="mt-1 block w-full rounded-md border border-gray-300 p-2 shadow-sm"
